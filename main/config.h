...
#define ENCODER_PWR GPIO_NUM_22
#define ENCODER_A_PIN GPIO_NUM_21
#define ENCODER_B_PIN GPIO_NUM_23
#define MOTOR_A_PIN GPIO_NUM_15
#define MOTOR_B_PIN GPIO_NUM_14
#define EXT_BUTTON_PIN  GPIO_NUM_3
#define LED_PIN GPIO_NUM_2
#define BUTTON_PIN  GPIO_NUM_9

#define BAT_LOW_PIN GPIO_NUM_18
#define BAT_ADC_PIN GPIO_NUM_1
#define TEMP_SDA_PIN GPIO_NUM_4
#define TEMP_SCL_PIN GPIO_NUM_5
#define TEMP_INT_PIN GPIO_NUM_0
